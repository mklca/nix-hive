...
in {
  ...
  darwinModules = import ./blocktypes/darwinModules.nix {inherit nixpkgs mkCommand;};
  ...
  homeModules = import ./blocktypes/homeModules.nix {inherit nixpkgs mkCommand;};
  nixosConfigurations = import ./blocktypes/nixosConfigurations.nix {inherit nixpkgs mkCommand;};
  nixosModules = import ./blocktypes/nixosModules.nix {inherit nixpkgs mkCommand;};
}
